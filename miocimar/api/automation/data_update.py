...
def sendNewNotification(notification_id):
    ...
    request_body = r'{ "to": "/topics/notifications","notification": {"title": "'+notification_object.title+'","subtitle": "'+notification_object.subtitle+'","notificationId": "'+str(notification_id)+'","subtitle": "'+notification_object.subtitle+'"}}'
