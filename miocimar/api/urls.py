...
router.register(r'languages', views.LanguageViewSet, 'languages')
router.register(r'local_forecast_translations', views.LocalForecastTranslationViewSet, 'local_forecast_translations')
